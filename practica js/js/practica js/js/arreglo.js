...
console.log("Array ordenado:", numeros); // Resultado: [1, 2, 4, 5, 7, 9]*/
let personas = [
    { nombre: "Juan", edad: 25 },
...
let personasordenadoporedad = personas.slice().sort((a, b) => a.edad - b.edad);
console.log(personasordenadoporedad);

// Mostrar el array ordenado
console.log("Personas ordenadas por edad de menor a mayor:");
